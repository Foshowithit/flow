			...
			<div className="min-h-dvh w-screen flex items-center justify-center bg-[#1a1a1a] px-4">
				<div className="w-full max-w-sm">
					<div className="mb-8 text-center">
						...
						<p className="text-sm text-[#c8c8d0] mt-1">Get started with Flow</p>
					</div>
					<div className="rounded-xl bg-yellow-500/10 border border-yellow-500/20 px-5 py-6 text-center">
						<p className="text-sm text-yellow-400 mb-3">
							Authentication is taking longer than expected. Sign up may be
			...
			<div className="w-full max-w-sm">
				...
				<ClerkLoading>
					<div className="flex flex-col items-center gap-4 py-12">
						...
						<p className="text-sm text-[#c8c8d0]">Loading sign-up…</p>
					</div>
				</ClerkLoading>
				...
				{/* Clerk loaded — render sign-up form */}
				<ClerkLoaded>
					<SignUp
				...
				<ClerkDegraded>
					<div className="rounded-xl bg-yellow-500/10 border border-yellow-500/20 px-5 py-6 text-center">
						<p className="text-sm text-yellow-400 mb-3">
							Sign-up is taking longer than expected. Please try again later.
						</p>
						<Link
							href="/"
							className="text-sm text-[#20b8cd] hover:text-[#1ba8bb] transition-colors"
